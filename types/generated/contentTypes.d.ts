...
export interface ApiCartCart extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cart_meta: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    stock_events: Schema.Attribute.Relation<
      'oneToMany',
      'api::stock-event.stock-event'
    >;
...
export interface ApiMealMeal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    available_to_purchase: Schema.Attribute.Boolean &
    ...
    price: Schema.Attribute.Decimal &
      ...
      >;
    publishedAt: Schema.Attribute.DateTime;
    recurring_stock: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    effective_order_date: Schema.Attribute.DateTime & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::order.order'> &
      Schema.Attribute.Private;
    order_cancelled_items: Schema.Attribute.JSON & Schema.Attribute.Required;
...
export interface ApiStockEventStockEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    event_source: Schema.Attribute.Enumeration<
      ['store', 'customer', 'operation team']
    > &
      Schema.Attribute.Required;
    event_time: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::stock-event.stock-event'
    > &
      Schema.Attribute.Private;
    meal: Schema.Attribute.Relation<'oneToOne', 'api::meal.meal'>;
    publishedAt: Schema.Attribute.DateTime;
    quantity: Schema.Attribute.Integer & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<['INCREMENT', 'DECREMENT']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiStoreCategoryStoreCategory
  extends Struct.CollectionTypeSchema {
...
export interface ApiStoreStore extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    enabled: Schema.Attribute.Boolean &
      ...
      Schema.Attribute.DefaultTo<true>;
    latlong: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    pickup_note: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    store_categories: Schema.Attribute.Relation<
      'manyToMany',
      'api::store-category.store-category'
    >;
    store_manager: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::users-permissions.user'
    >;
    updatedAt: Schema.Attribute.DateTime;
